...
import { isLogedIn , ownerAuthorization, ownerAuthorizationCourt, ownerAuthorizationFacility} from "../../../middlewares.js";
const router = express.Router({mergeParams: true});

router.route("/new").post(isLogedIn,ownerAuthorization,ownerAuthorizationFacility,createCourt);
router.route("/:courtId/delete").delete(isLogedIn,ownerAuthorization,ownerAuthorizationCourt,deleteCourt);
router.route("/:courtId/edit").patch(isLogedIn,ownerAuthorization,ownerAuthorizationCourt,updateCourt);
